            	...
            	<div className="container">
            		<nav className="navbar flex items-center" aria-label="Main Navigation">
            			...
            			<div className="navbar__branding mr-2">
            				...
            				<Link className="navbar__logo m-0" to={withPrefix('/')}><img style={{ height: '90px', minWidth: '150px' }} src={withPrefix(_.get(this.props, 'pageContext.site.siteMetadata.header.logo', null))} alt={_.get(this.props, 'pageContext.site.siteMetadata.header.logo_alt', null)} /></Link>
            				) : 
